...
class EncoderDecoder(BaseSegmentor):
    ...
    def generate_pseudo_label_with_proj(self, img, img_metas, up=True):
        return self.encode_decode_with_proj(img, img_metas, up)

    def generate_pseudo_label_with_scale(self, img, img_metas, up=True):
        return self.encode_decode_with_scale(img, img_metas, up)
    ...
    def _decode_head_forward_train_mix(self,
                                       x,
                                       img_metas,
                                       gt_semantic_seg,
                                       seg_weight=None, ):
        ...
        training."""
        losses = dict()
        loss_decode = self.decode_head.forward_train_mix(x,
                                                         img_metas,
                                                         gt_semantic_seg,
                                                         self.train_cfg,
                                                         seg_weight)
    ...
    def _decode_head_forward_train_source(self,
                                          x,
                                          emb,
                                          img_metas,
                                          gt_semantic_seg,
        ...
        losses = dict()
        loss_decode = self.decode_head.forward_train_source(x, img_metas, emb,
                                                            gt_semantic_seg,
                                                            self.train_cfg,
                                                            seg_weight,
                                                            prepare_dict)
